...
class Config:
    ...
    # 程序基础配置信息
    ##
    appName = 'AlphaQuantBridge'  # 应用名称
    appNameEN = 'alpha_quant_bridge'    # 应用名称-英文（用于生成缓存文件夹，必须是英文）
    appVersion = "V0.1.0"  # 应用版本号
    appDeveloper = "zhao"  # 应用开发者
    appBlogs = "https://blog.pangao.vip"  # 个人博客
    appPackage = 'alpha.quant.bridge'    
    appUpdateUrl = ''    # 未配置发布源时不检查更新
